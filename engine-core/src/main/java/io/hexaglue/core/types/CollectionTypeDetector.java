...
/**
 * Utility for detecting collection types and their characteristics.
 *
 * <p>This class provides methods to identify Java collection types (List, Set, Map, etc.)
 * based on their qualified names. It handles both concrete implementations and interfaces
 * from the Java Collections Framework.</p>
 *
 * <h2>Supported Types</h2>
 * <ul>
 *   <li><strong>List:</strong> java.util.List and common implementations (ArrayList, LinkedList, etc.)</li>
 *   <li><strong>Set:</strong> java.util.Set and common implementations (HashSet, TreeSet, etc.)</li>
 *   <li><strong>Map:</strong> java.util.Map and common implementations (HashMap, TreeMap, etc.)</li>
 *   <li><strong>Collection:</strong> java.util.Collection and other unspecified collections</li>
 * </ul>
 *
 * <h2>Thread Safety</h2>
 * <p>All methods are thread-safe and side-effect free.</p>
 */
public final class CollectionTypeDetector {
     ...
     * </ul>
     *
     * @param qualifiedName fully-qualified class name (not {@code null})
     * @return collection kind or empty if not a known collection type
     */
    public static Optional<CollectionKind> detectCollectionKind(String qualifiedName) {
    ...
    public static boolean isCollectionType(String qualifiedName) {
        return detectCollectionKind(qualifiedName).isPresent();
    }
     ...
     */
    public static boolean isListType(String qualifiedName) {
     ...
     */
    public static boolean isSetType(String qualifiedName) {
        return SET_TYPES.contains(qualifiedName);
    }
     ...
     */
    public static boolean isMapType(String qualifiedName) {
